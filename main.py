...
if __name__ == '__main__':
    ...
    parser.add_argument('--episodes', type=int, default=200, help='Number of episodes to train the agent')
    ...
    parser.add_argument('--save_path', type=str, default='/Users/mbp_q/Desktop/PythonWorkspace/ds/Kazuma_Kiryu.pth', help='Path to save the trained model')
